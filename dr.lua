...
local target = workspace.PartyZones.PartyZone.WorldPivot.Position
hrp.CFrame = CFrame.new(target) local found = true
elseif workspace.PartyZones.PartyZone1.BillboardGui.StatusLabel.Text == "Waiting for players..." then
local target = workspace.PartyZones.PartyZone1.WorldPivot.Position
hrp.CFrame = CFrame.new(target) local found = true
elseif workspace.PartyZones.PartyZone2.BillboardGui.StatusLabel.Text == "Waiting for players..." then
local target = workspace.PartyZones.PartyZone2.WorldPivot.Position
hrp.CFrame = CFrame.new(target) local found = true
elseif workspace.PartyZones.PartyZone3.BillboardGui.StatusLabel.Text == "Waiting for players..." then
local target = workspace.PartyZones.PartyZone3.WorldPivot.Position
hrp.CFrame = CFrame.new(target) local found = true
else
fp()
end
...
game:GetService("ReplicatedStorage"):WaitForChild("Shared"):WaitForChild("Network"):WaitForChild("RemoteEvent"):WaitForChild("CreateParty"):FireServer(unpack(args)) end
else
